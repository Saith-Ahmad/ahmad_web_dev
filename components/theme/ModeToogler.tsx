...
export function ModeToggle() {
  ...
  return (
    <Button variant="outline" size={'icon'}  onClick={() => setTheme(theme === 'light' ? "dark" : "light")} className="bg-text_purple relative">
      <span className="absolute inset-0 scale-110 -z-[5] rounded-md opacity-40 wave"></span>
